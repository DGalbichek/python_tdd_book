...
class SendLoginEmailViewTest(TestCase):
    ...
    def test_adds_success_message(self):
        ...
        self.assertEqual(message.message, "Check your email, we've just sent you a link you can use to log in.")
...
class LoginViewTest(TestCase):
    ...
    def test_calls_authenticate_with_uid_from_get_request(self, mock_auth):
        ...
        self.assertEqual(mock_auth.authenticate.call_args[1], call(None, uid='abcd123')[2])
